{
    ...
    'version': '4.8.11',
    'category': 'Accounting',
    'summary': """ Asset and Budget Management, Accounting Reports, PDC, Lock dates, Credit Limit, Follow Ups, Day-Bank-Cash book reports for Odoo v13.""",
    'description': """
    ...
    'depends': ['sale', 'account_check_printing'],
    'data': [
